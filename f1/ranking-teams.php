<?php require "koneksi/klasemen/koneksi_klasemen_teams.php"; ?>
...
<body>
    ...
    <div class="container-fluid mt-3">
        <table class="table">
            ...
            <tbody>
            <?php foreach($dataRankingsTeams['response'] as $rowTeams ){
                ?>
              <tr>
                <th scope="row"><?php echo $rowTeams['position']; ?></th>
                <td><?php echo $rowTeams['team'] ['name']; ?></td>
                <td><?php echo $rowTeams['points']; ?></td>
              </tr>
              <?php 
                } ?>
            </tbody>
